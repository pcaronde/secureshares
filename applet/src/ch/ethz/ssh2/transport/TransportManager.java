 ...
 * @version $Id: TransportManager.java,v 1.1 2006/07/31 14:12:25 cticu Exp $
 */
public class TransportManager
{
    ...
    public void close(Throwable cause, boolean useDisconnectPacket)
    {
        if (useDisconnectPacket == false)
        {
            ...
            /* OK, whoever tried to send data, should now agree that
                ...
                * It is save now to aquire the semaphore.
                */
        }
    ...
    public void initialize(CryptoWishList cwl, ServerHostKeyVerifier verifier, DHGexParameters dhgex,
                           int connectTimeout, SecureRandom rnd) throws IOException
    {
    ...
    public void kexFinished() throws IOException
    {
        synchronized (connectionSemaphore)
        {
            ...
            for (int i = 0; i < kexBlockedSendQueue.size(); i++)
            {
                tc.sendMessage((byte[]) kexBlockedSendQueue.elementAt(i));
            }
        ...
        synchronized (connectionSemaphore)
        {
            while (true)
            {
                ...
                if (Thread.currentThread() == receiveThread)
                {
                    ...
                    // Use a queue for non-KEX reply packets
                    // which were generated in the receive thread
                    kexBlockedSendQueue.addElement(msg);
                    return;
                }
